document.addEventListener('DOMContentLoaded', () => {
    // Pega o ID do produto da URL (ex: produto.html?id=5)
    ...
    // Busca os dados do produto específico no backend
